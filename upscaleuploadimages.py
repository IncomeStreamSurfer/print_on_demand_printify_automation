...
import base64
import os
from config import access_token, shop_id, base_url  # Import necessary variables from config.py

def upscale_upload_images():  # Encapsulate the main functionality in a function
    # The URL for the API endpoints
